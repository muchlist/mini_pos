...
var doc = `{
    ...
    "paths": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/dto.OutletModel"
                                        }
                                    }
                                }
                            ]
        ...
        "/outlets": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Search apabila di isi akan melakukan pencarian berdasarkan nama outlet",
                        "name": "search",
                        "in": "query"
                    }
                ],
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.OutletCreateRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.OutletEditRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/products": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "tambahkan outlet untuk melihat harga outlet tertentu",
                        "name": "outlet",
                        "in": "query"
                    }
                ],
        ...
        "/products-image/{id}": {
            "post": {
                ...
                "operationId": "product-upload-photo",
                "parameters": [
                    {
                        "type": "file",
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.ProductEditRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.ProductPriceRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "dto.OutletCreateRequest": {
            "type": "object",
            "properties": {
                "address": {
                    "type": "string",
                    "example": "Jl Pangeran Samudera"
                },
                "outlet_name": {
                    "type": "string",
                    "example": "BLOK B"
        ...
        "dto.ProductModel": {
            ...
            "properties": {
                "buy_price": {
                    "description": "berasal dari table lain",
                    "type": "integer",
                    "example": 1000000
                },
                "code": {
                ...
                "image": {
                    "type": "string",
                    "example": "image/products/121634211915.jpg"
                },
                "master_buy_price": {
                    "type": "integer",
                    "example": 1000000
